...
terminal = (is_linux and sys.argv[0] == "./eldubte_pydub_wav.py") or (not is_linux and sys.argv[0] == "eldubte_pydub_wav.py")
if not terminal:
...
def mostra_sentencia(text, ends):
   ...
   text = f"{c.BG_CYN+text:<60}" if (text[:6] == "ESCENA") else ini_color+text
